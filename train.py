...
def clean_data(data):
    ...
    features = [col for col in df.columns.values if col not in ["Survived"]]
    x_df = df[features]
    y_df = df["Survived"]
    return x_df, y_df
...
def main():
    ...
    data_url = "https://raw.githubusercontent.com/Maithikimngan/nd00333-capstone/refs/heads/main/train_survival.csv"
